...
public class TitleManager : MonoBehaviour
{
    ...
    const string accountLoginURL = "http://ik1-423-43506.vs.sakura.ne.jp/user/account/login";   // アカウントログインURL
    ...
    const string guestLoginURL = "http://ik1-423-43506.vs.sakura.ne.jp/user/guest/login";       // ゲストログインURL
    ...
    const string createAccountURL = "http://ik1-423-43506.vs.sakura.ne.jp/user/account/create"; // アカウント作成URL
